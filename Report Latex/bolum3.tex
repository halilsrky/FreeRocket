...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{sekiller/FreeRTOSGörevMimarisi.png}
    \caption{FreeRTOS Görevleri Arası Bağımlılık ve Sinyal Akış Diyagramı}
    \label{fig:freertos_gorev_mimarisi}
\end{figure}
